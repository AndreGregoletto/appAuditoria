<x-layout-default>
    <form action="{{ route('user.update', $oUser->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
                ...
                <div class="col-6">
                    ...
                    <div class="col-12">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control disabled" placeholder="Login" aria-label="Login" aria-describedby="basic-addon1" name="username" value="{{ $oUser->username }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="CPF" aria-label="CPF" aria-describedby="basic-addon1" name="cpf" id="cpf" value="{{ $oUser->cpf }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Celular" aria-label="Celular" aria-describedby="basic-addon1" name="cellphone" id="cellphone" value="{{ $oUser->cellphone }}">
                        </div>
                    </div>
